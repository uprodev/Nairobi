                ...
                <div class="left">
                    ...
                    <div class="input-wrap input-big-check">
                        ...
                        <div class="wrap">
                            ...
                            ?>
                            <div class="item">
                                <input type="radio" value="<?= get_the_id() ?>" id="select-1-<?= $i?>>" name="product">
                            ...
                            <div class="item">
                                <input type="radio" id="select-1-3" name="product">
                                ...
                                <div class="wrap-check">
                                    <div class="check-item">
                                        ...
                                        <label for="check-2-1" class="round-check">
                                            <img src="<?= get_stylesheet_directory_uri() ?>/img/icon-5-1.svg" alt="">
                                    ...
                                    <div class="check-item">
                                        ...
                                        <label for="check-2-2" class="round-check">
                                            <img src="<?= get_stylesheet_directory_uri() ?>/img/icon-5-2.svg" alt="">
                                    ...
                                    <div class="check-item">
                                        ...
                                        <label for="check-2-3" class="round-check">
                                            <img src="<?= get_stylesheet_directory_uri() ?>/img/icon-5-3.svg" alt="">
                                    ...
                                    <div class="check-item">
                                        ...
                                        <label for="check-2-4" class="round-check">
                                            <img src="<?= get_stylesheet_directory_uri() ?>/img/icon-5-4.svg" alt="">
                                    ...
                                    <div class="check-item">
                                        ...
                                        <label for="check-2-5" class="round-check">
                                            <img src="<?= get_stylesheet_directory_uri() ?>/img/icon-5-5.svg" alt="">
                                    ...
                                    <div class="check-item">
                                        ...
                                        <label for="check-2-6" class="round-check">
                                            <img src="<?= get_stylesheet_directory_uri() ?>/img/icon-5-6.svg" alt="">
                                    ...
                                    <div class="check-item">
                                        ...
                                        <label for="check-2-7" class="round-check">
                                            <img src="<?= get_stylesheet_directory_uri() ?>/img/icon-5-7.svg" alt="">
                                    ...
                                    <div class="check-item">
                                        ...
                                        <label for="check-2-8" class="round-check">
                                            <img src="<?= get_stylesheet_directory_uri() ?>/img/icon-5-8.svg" alt="">
