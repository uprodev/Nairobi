    ...
    <div class="text-wrap">
        ...
        <div class="cost-wrap">
            ...
            <div class="input-number ">
                ...
                <input type="text" name="count" value="1" max="9" min="1" class="form-control" readonly/>
                <div class="btn-count btn-count-minus"><img src="<?= get_stylesheet_directory_uri() ?>/img/icon-4-1.svg" alt=""></div>
            </div>
        </div>
        <div class="brn-wrap">
            <a href="?add-to-cart=<?= get_the_ID() ?>" class="btn-default add_to_cart " data-product_id="<?= get_the_ID() ?>"><img src="<?= get_stylesheet_directory_uri() ?>/img/icon-12.svg" alt=""><?php _e('Order Now', 'Nairobi') ?></a>
        </div>
    </div>
</div>
